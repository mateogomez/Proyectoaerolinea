 ...
 * @author mateo
 */
public class FrmMireserva extends javax.swing.JFrame {
    ...
    public FrmMireserva(String nombre, String cedulacliente) {
        initComponents();
        this.nombre = nombre;
    ...
    private void initComponents() {
        ...
        JtbPagos = new javax.swing.JTable();
        ...
        JtbPagos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "numero reserva", "Numero vuelo", "Estado reserva"
            }
        ));
        jScrollPane1.setViewportView(JtbPagos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMireserva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMireserva().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable JtbPagos;
