...
public class CtlAvion {
    ...
    public ArrayList<ClsAvion> registrarAvion(ArrayList<ClsAvion> listaAvion, String serial, int capacidad, String codigoPiloto, String codigoPrimeraazafata, String codigoSegundaazafata) {

        try {

            if (listaAvion.isEmpty()) {
                ClsAvion avion = new ClsAvion(serial, capacidad, codigoPiloto, codigoPrimeraazafata, codigoSegundaazafata);
    ...
    public ArrayList<ClsAvion> modificarAvion(ArrayList<ClsAvion> listaAvion, String serial, int capacidad, String codigoPiloto, String codigoPrimeraazafata, String codigoSegundaazafata) {
        int encontrado = 0;
        for (int i = 0; i < listaAvion.size(); i++) {
            if (serial.equals(listaAvion.get(i).getSerial())) {
                ...
                listaAvion.get(i).setCodigoPrimeraazafata(codigoPrimeraazafata);
                listaAvion.get(i).setCodigoSegundaazafata(codigoSegundaazafata);
    ...
    public DefaultTableModel listarElementos(ArrayList<ClsAvion> listaAvion) {
        ...
        String nombreColumnas[] = {"Serial", "Capacidad", "Codigo Piloto", "Codigo primera azafata", "Codigo segunda azafata"};
        ...
        try {
            ...
            for (int i = 0; i < listaAvion.size(); i++) {
                ...
                modelo.addRow(new Object[]{listaAvion.get(i).getSerial(), listaAvion.get(i).getCapacidad(), listaAvion.get(i).getCodigoPiloto(), listaAvion.get(i).getCodigoPrimeraazafata(),
                    listaAvion.get(i).getCodigoSegundaazafata()});
